...
| Everything offline | Core exercise logic is offline; Claude features need the internet | Rep counting and safety rules stay local. Voice intents, generated feedback, and Echo's fallback call Claude through a laptop proxy. Echo prefers on-device Gemma. See `second-voice-proxy/README.md`. |
